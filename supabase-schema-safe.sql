-- ============================================
-- SCHEMA SEGURO - PODE SER EXECUTADO MÚLTIPLAS VEZES
-- Este script remove e recria todas as tabelas
-- ============================================

-- IMPORTANTE: Isso vai DELETAR todos os dados existentes!
...
DROP TABLE IF EXISTS pivos CASCADE;
