          ...
          <div className="max-w-4xl mx-auto flex justify-around py-3">
            <Link 
              ...
              className={`flex flex-col items-center py-2 px-4 ${
                currentPageName === 'Home' ? 'text-white' : 'text-emerald-200 hover:text-white'
              }`}
            >
            ...
            <Link 
              ...
              className={`flex flex-col items-center py-2 px-4 ${
                currentPageName === 'AcompanhamentoIrrigacao' ? 'text-white' : 'text-emerald-200 hover:text-white'
              }`}
            >
            ...
            <Link 
              ...
              className={`flex flex-col items-center py-2 px-4 ${
                currentPageName === 'HistoricoPivo' ? 'text-white' : 'text-emerald-200 hover:text-white'
              }`}
            >
